...
<div class="background">
    <div class="background-image">
        <img src="{{asset('user/assets/img/include_image/bg_register1.jpg')}}" alt="">
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                <form class="form clearfix" action="{{route('post_register')}}" method="POST" id="register"
                    ...
                    <div class="form-group">
                        ...
                        <input name="nomor_telpon" type="number"
                    ...
                    <!-- whatsapp number -->
                    <div class="form-group">
                        <label for="no_wa" class="col-form-label required">Nomer Whatsapp</label>
                        <input name="no_wa" type="number" class="form-control @error('no_wa') is-invalid @enderror"
                    ...
                    <!-- instagram -->
                    <div class="form-group">
                        <label for="instagram" class="col-form-label required">Instagram</label>
                    ...
                    <div class="form-group">
                        @csrf
                        <label for="imgInp" class="col-form-label required">Foto Profile</label>
