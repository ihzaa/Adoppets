                    ...
                    <div class="item">
                        <div class="wrapper">
                            ...
                            <div class="admin-controls">
                                ...
                                <form action="{{route('delete_clinic',['id'=>$item->id])}}" method="POST" class="form-hapus">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <!--end description-->
                            <!--end addition-info-->
                            <a href="{{route('detail_clinic', ['id'=>$item->id])}}" class="detail text-caps underline">Detail</a>
                        </div>
                    </div>
                    @endforeach
