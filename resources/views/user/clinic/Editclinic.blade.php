...
<section class="block">
    <div class="container">
        <form class="form form-submit" action="{{route('store_update_clinic',['id'=> $data->id])}}" method="POST"
            id="submitclinic" enctype="multipart/form-data">
            @csrf
            <section>
                <h2>Konten</h2>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="nama_klinik" type="text"
                                ...
                                placeholder="contoh : Klinik Bakti Husada" required value="{{$data->nama_klinik}}">
                        </div>
                        @error('nama_klinik')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="no_telepon" type="text"
                                ...
                                placeholder="contoh : 03321245161" required value="{{$data->no_telepon}}">
                        </div>
                        @error('no_telepon')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                id="email" placeholder="contoh : klinikhusada@gmail.com" value="{{$data->email}}">
                        </div>
                        @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
