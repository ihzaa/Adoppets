...
<div id="page-head">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Data Report Posting Clinic</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
...
<div id="page-content">
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Report Posting Clinic</h3>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href=" {{route('report_klinik_detail',$item->id)}}" class="btn btn-warning btn-rounded">
                                Detail
                            </a>
...
<script>
    const URL = {
        delete : "{{route('admin.delete.report.clinic','astaga')}}",
        block : "{{route('admin.block.report.clinic','astaga')}}"
    }
