...
@section('title')
List Report Postingan Blog {{$data['blog']->title}}
@endsection
...
<div id="page-head">
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">Detail Data Report Posting Blog {{$data['blog']->title}}</h1>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <!--End page title-->
...
<div id="page-content">
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Detail Report Posting Blog {{$data['blog']->title}}</h3>
        </div>
